function [strain]=vel2strain_savage_novcm(trim,vel,nring,outdir,ndim)
%============================================================
...
%[pole]=eulertrans_novcm(m(:,1:3),theta0,phi0);
...
[peps]=prinstrain_novcm(m(:,4:6),1);
%final strain
strain=[trim.x,trim.y,m(:,4:6),peps,0*peps,0*peps];
